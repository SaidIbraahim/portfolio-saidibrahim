...
const projects = [
  {
    ...
    image: 'https://www.freepik.com/free-photo/front-view-elections-concept-with-copy-space_7645750.htm#fromView=search&page=1&position=44&uuid=91285cca-5d8c-426f-95a7-6e8a9c30076b&query=Online+Voting',
  ...
  },
  {
    ...
    description: 'Advanced content generation platform using GPT-3 for creating marketing copy and social media posts.',
    image: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&w=800&q=80',
    tech: ['Next.js', 'OpenAI API', 'Tailwind CSS', 'Vercel'],
    liveUrl: 'https://projects.saidibrahim.tech/ai-content',
    githubUrl: 'https://github.com/saidibrahim/ai-content',
    type: 'development'
  },
  {
