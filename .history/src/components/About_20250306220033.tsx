          ...
          <div className="flex flex-col md:flex-row gap-8 items-center mb-12">
            ...
            <div className="w-full md:w-2/3">
              <p className="text-lg text-gray-700 mb-6">
                With over 8 years of experience in software development and UX design, I specialize in creating intuitive digital experiences that bridge the gap between user needs and technical excellence. My approach combines clean code with user-centered design principles.
              </p>
