    ...
    <section id="home" className="min-h-screen flex flex-col justify-center relative overflow-hidden pt-20 px-6">
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
        <div className="lg:col-span-3 space-y-6 animate-fade-in-up">
          <div className="inline-block px-3 py-1 bg-accent/10 text-accent rounded-full text-sm font-medium mb-2 animate-fade-in animate-delay-200">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-xl animate-fade-in animate-delay-400">
            I craft beautiful, user-focused digital experiences with modern technologies 
            and thoughtful design principles.
          </p>
          
          <div className="pt-4 flex flex-col sm:flex-row sm:items-center gap-4 animate-fade-in animate-delay-500">
